...
export default function PlayfulCanadaLander() {
  const affiliateUrl = useAffiliateLink(LANDERS.playfulcanada.baseAffiliateUrl);

  return (
    <>
      <TikTokPixel pixelId={LANDERS.playfulcanada.pixelId} />
